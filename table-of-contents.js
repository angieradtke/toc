 ...
 * check if element is in view ->  add class="active" to menuitem
 * heading class=skip -> skips heading in TocList
 * data-heading ->  alternative   Item-Content in TocList
 *
 *
 *
 *
...
function headingView() {
	...
	for (var i = 0; i < elements.length; i++) {
		...
		else {  	var tocitems = document.querySelectorAll(".tocitems");
